...
/** @Entity @Table(names="utilisateur") */
...
class Utilisateur implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'userid', targetEntity: Temoignage::class)]
    ...
    public function removeTemoignage(Temoignage $temoignage): static
    {
        if ($this->temoignages->removeElement($temoignage)) {
            ...
            if ($temoignage->getUserid() === $this) {
                $temoignage->setUserid(null);
            }
        }
